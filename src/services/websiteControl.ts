 ...
 */
router.post('/:storeId/enable', async (req: Request, res: Response) => {
    try {
 ...
 */
router.post('/:storeId/disable', async (req: Request, res: Response) => {
    try {
        const { reason } = req.body;
 ...
 */
router.post('/:storeId/maintenance', async (req: Request, res: Response) => {
    try {
 ...
 */
router.post('/:storeId/logs/revert', async (req: Request, res: Response) => {
    try {
