...
export class ImageWithAISEOService {
     ...
     */
    async uploadProductImageWithAISEO(
        tenantId: string,
        productId: string,
        ...
        try {
            ...
            const seoResult = await AISEOService.autoGenerateProductSEO(
                productId,
                productName,
                category,
                nicheType,
    ...
    async bulkUploadWithAISEO(
        ...
        try {
            ...
            for (const file of files) {
                const result = await this.uploadProductImageWithAISEO(
                    tenantId,
                    productId,
                    file,
                    productName,
