...
router.post('/generate/:productId', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.autoGenerateProductSEO(
            productId as string,
            productName,
            category,
            nicheType,
...
router.post('/description', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.generateProductDescription(
            productName,
            category,
            nicheType,
            imageUrl
...
router.post('/keywords', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.generateSEOKeywords(
            productName,
            description,
            category,
            nicheType
...
router.post('/alt-text', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.generateAltText(
            productName,
            category,
            imageAnalysis
        );
...
router.post('/optimize-title', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.optimizeProductTitle(
            currentTitle,
            category,
            nicheType
        );
 ...
 */
router.post('/structured-data', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.generateStructuredData(
            productName,
            description,
            price,
            category,
...
router.get('/:productId', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.getProductSEO(productId as string);
...
router.put('/:productId', async (req: Request, res: Response) => {
    try {
        ...
        const result = await AISEOService.updateProductSEO(productId as string, updates);
 ...
 * Calculate SEO score
 */
router.get('/:productId/score', async (req: Request, res: Response) => {
    try {
        const productId = req.params.productId;

        const result = await AISEOService.calculateSEOScore(productId as string);
